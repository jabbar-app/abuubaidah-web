    ...
    <ul class="navbar-nav flex-row align-items-center ms-auto">
      ...
      <li class="nav-item navbar-dropdown dropdown-user dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-end">
          <li>
            <a class="dropdown-item" href="{{ route('profile.edit') }}">
              <div class="d-flex">
                ...
                <div class="flex-grow-1">
                  <span class="fw-medium d-block">{{ explode(' ', Auth::user()->name)[0] }}</span>
          ...
          <li>
            <a class="dropdown-item" href="{{ route('my.program') }}">
          ...
          <li>
            <a class="dropdown-item" href="{{ route('my.transaction') }}">
              <span class="d-flex align-items-center align-middle">
                ...
                <span class="flex-grow-1 align-middle">Data Transaksi</span>
          ...
          <li>
            <a class="dropdown-item" href="https://wa.me/628116144482">
              <i class="ti ti-help me-2 ti-sm"></i>
              <span class="align-middle">WhatsApp Admin</span>
            </a>
          </li>
          <li>
            <a class="dropdown-item" href="https://abuubaidah.com/" target="_blank">

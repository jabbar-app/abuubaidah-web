          ...
          <form action="{{ route('create.invoice') }}" method="POST" class="card-body">
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-9">
                ...
                <input type="text" id="multicol-program" class="form-control" value="{{ $program->programmable->title ?? 'No Program Title' }}" name="program" readonly />
              </div>
            </div>
            <div class="row mb-3">
              <label class="col-sm-3 col-form-label" for="multicol-batch">Angkatan</label>
              <div class="col-sm-9">
                <input type="text" id="multicol-batch" class="form-control" value="{{ $program->programmable->batch ?? 'No Program Batch' }}" name="batch" readonly />
              </div>
            </div>
            <div class="row mb-3">

        ...
        <div class="row">
            ...
            <div class="col-xxl">
                <div class="card mb-4">
                    ...
                    <form action="{{ route('kelas.store') }}" method="POST" class="card-body">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                ...
                                <input type="text" id="multicol-name" class="form-control"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="multicol-alumni" class="form-control" value="{{ $alumni }}"
                                    readonly />
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                ...
                                <input type="text" id="multicol-program" class="form-control" value="{{ $program->title }}" name="program" readonly/>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label class="col-sm-3 col-form-label" for="multicol-batch">Angkatan</label>
                            <div class="col-sm-9">
                                <input type="text" id="multicol-batch" class="form-control" value="{{ $program->batch }}" name="batch" readonly/>
                            </div>
                        </div>
                        <div class="row mb-3">

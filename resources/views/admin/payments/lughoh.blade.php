...
@section('content')
  <div class="container-xxl flex-grow-1 container-p-y">
    <div class="d-flex justify-content-between align-items-center my-4">
      <h4 class="text-primary mt-3"><a href="{{ route('dashboard') }}" class="text-muted fw-light">Dashboard /</a> Data Transaksi I'dad Lughowi</h4>
    ...
    <div class="row mb-4">
      ...
      <div class="col-6">
        <a href="{{ route('export.payment.lughoh', ['batch' => request('batch')]) }}" class="btn btn-outline-primary float-end">Export ke Excel</a>
      </div>
    </div>
    ...
    <div class="card">
      <div class="card-body">
        <div class="card-title header-elements">
          <h5 class="m-0 me-2">Data Transaksi I'dad Lughowi</h5>

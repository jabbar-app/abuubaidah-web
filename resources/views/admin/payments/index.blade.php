                ...
                <td>
                  <div class="d-inline-block"><a href="javascript:;"
                    ...
                    <ul class="dropdown-menu dropdown-menu-end m-0" style="">
                      ...
                      <li><a href="{{ $payment->invoice_url }}" target="_blank" class="dropdown-item">Lihat Invoice</a>
                      </li>
                  ...
                  </div><a href="{{ route('payments.edit', $payment->id) }}" class="btn btn-sm btn-icon item-edit"><i

        ...
        <div class="card-body">
          ...
          <form action="{{ route('lughohs.update', $lughoh->id) }}" method="POST">
            ...
            <div class="mb-3">
              ...
              <input type="number" class="form-control" id="price_normal" name="price_normal" value="{{ $lughoh->price_normal }}">
            </div>
            <div class="mb-3">
              <label for="price_alumni" class="form-label">Biaya Alumni</label>
              <input type="number" class="form-control" id="price_alumni" name="price_alumni" value="{{ $lughoh->price_alumni }}">
            </div>
            <div class="mb-3 select2-primary">

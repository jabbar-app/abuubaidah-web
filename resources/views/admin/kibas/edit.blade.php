...
@section('content')
  <div class="container-xxl flex-grow-1 container-p-y">
    <div class="d-flex justify-content-between align-items-center my-4">
      ...
      <a href="{{ route('kibas.index') }}" class="btn btn-md btn-light">Kembali</a>
    </div>
    ...
    <div class="d-flex justify-content-center">
      <div class="card col-xl-8 col-md-10 col-sm-12">
        ...
        <div class="card-body">
          ...
          <form action="{{ route('kibas.update', $kiba->id) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="number" class="form-control" id="batch" name="batch" value="{{ $kiba->batch }}">
            </div>
            <div class="mb-3 select2-primary">
              <label class="col-sm-3 col-form-label" for="option-select">Tipe Kelas</label>
              <div class="col-12">
                @php
                  $selectedOptions = json_decode($kiba->option);
                @endphp
            ...
            <div class="mb-3">
              ...
              <textarea class="form-control" id="description" name="description">{{ $kiba->description }}</textarea>
            </div>
            <div class="mb-3">
              <label for="price_normal" class="form-label">Biaya Normal</label>
              <input type="number" class="form-control" id="price_normal" name="price_normal" value="{{ $kiba->price_normal }}">
            </div>
            <div class="mb-3">
              <label for="price_alumni" class="form-label">Biaya Alumni</label>
              <input type="number" class="form-control" id="price_alumni" name="price_alumni" value="{{ $kiba->price_alumni }}">
            </div>
            <div class="mb-3 select2-primary">
              ...
              <div class="col-12">
                ...
                @php
                  $selectedOptions = json_decode($kiba->session, true);
            ...
            <div class="mb-5">
              ...
              <select name="status" id="status" class="form-select">
                <option value="1" @if ($kiba->status) selected @endif>Aktif</option>
                <option value="0" @if (!$kiba->status) selected @endif>Tidak Aktif</option>
              </select>
            </div>

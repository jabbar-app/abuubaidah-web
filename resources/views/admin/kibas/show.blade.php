      ...
      <div class="card col-xl-8 col-md-10 col-sm-12">
        ...
        <div class="card-body">
          ...
          <div class="mb-3">
            ...
            <p>{{ $kiba->description }}</p>
          </div>
          <div class="mb-3">
            <small>Biaya Normal</small>
            <h5>Rp{{ number_format($kiba->price_normal, 0, ',', '.') }},-</h5>
          </div>
          <div class="mb-3">
            <small>Biaya Alumni</small>
            <h5>Rp{{ number_format($kiba->price_alumni, 0, ',', '.') }},-</h5>
          </div>
          <div class="my-5">
            <small>Status</small>
            @if ($kiba->status)
          ...
          <a href="{{ route('kibas.edit', $kiba->id) }}" class="btn btn-primary float-end">Edit Data</a>

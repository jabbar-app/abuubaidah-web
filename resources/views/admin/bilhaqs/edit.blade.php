        ...
        <div class="card-body">
          ...
          <form action="{{ route('bilhaqs.update', $bilhaq->id) }}" method="POST">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="title" name="title" value="{{ $bilhaq->title }}">
            </div>
            <div class="mb-3">
              <label for="batch" class="form-label">Angkatan</label>
              <input type="number" class="form-control" id="batch" name="batch" value="{{ $bilhaq->batch }}">
            </div>
            <div class="mb-3 select2-primary">
              <label class="col-sm-3 col-form-label" for="option-select">Tipe Kelas</label>
              <div class="col-12">
                @php
                  $selectedOptions = json_decode($bilhaq->option);
                @endphp
            ...
            <div class="mb-3 select2-primary">
              ...
              <div class="col-12">
                ...
                @php
                  $selectedOptions = json_decode($bilhaq->session, true);
            ...
            <div class="mb-5">
              ...
              <select name="status" id="status" class="form-select">
                <option value="1" @if ($bilhaq->status) selected @endif>Aktif</option>
                <option value="0" @if (!$bilhaq->status) selected @endif>Tidak Aktif</option>
              </select>
            </div>

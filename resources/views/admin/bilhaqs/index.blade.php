          ...
          <tbody>
            @foreach ($bilhaqs as $bilhaq)
              <tr>
                ...
                <td>
                  @php
                    $options = json_decode($bilhaq->option, true);
                  @endphp
                  @if (is_array($options))
                ...
                <td>
                  <div class="d-inline-block">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end m-0" style="">
                      ...
                      <li>
                        <form action="{{ route('bilhaqs.destroy', $bilhaq->id) }}" method="POST"
                          onsubmit="return confirm('Are you sure you want to delete this bilhaq?');">
                          @csrf
                          @method('DELETE')
                  ...
                  <a href="{{ route('bilhaqs.edit', $bilhaq->id) }}" class="btn btn-sm btn-icon item-edit"

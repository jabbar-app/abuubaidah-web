          ...
          <div class="mb-3">
            ...
            <select name="programmable_id" id="programmable_id" class="form-select">
              <option value="{{ $program->programmable_id }}">
                {{ $program->programmable->title . ' Angkatan ' . $program->programmable->batch }}
              </option>
            </select>
          </div>

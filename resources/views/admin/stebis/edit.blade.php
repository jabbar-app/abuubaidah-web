        ...
        <div class="card-body">
          ...
          <form action="{{ route('stebis.update', $stebis->id) }}" method="POST">
            ...
            <div class="mb-3">
              ...
              <input type="number" class="form-control" id="price_normal" name="price_normal" value="{{ $stebis->price_normal }}">
            </div>
            <div class="mb-3">
              <label for="price_alumni" class="form-label">Biaya Alumni</label>
              <input type="number" class="form-control" id="price_alumni" name="price_alumni" value="{{ $stebis->price_alumni }}">
            </div>
            <div class="mb-3 select2-primary">
              ...
              <div class="col-12">
                ...
                @php
                  $selectedOptions = json_decode($stebis->session, true);
